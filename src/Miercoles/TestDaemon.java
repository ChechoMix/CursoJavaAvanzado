...
Un hilo Demonio en java es un hilo prooveedor de servicios que proporciona servicios al hilo de usuario.
Su vida depende de los demas hilos, es decir si todos los demas hilos se mueren la JVM lo termina automaticamente.

Hay muchos hilos demonios en java que se ejecutan automaticamente.
gc, finalizer, etc.

Jconsole en el simbolo del sistema, proporciona la informacion sombre las clases cargadas, uso de memoria, 
ejecucion de hilos, etc.

Puntos importantes:
Un hilo en java proporciona servicios a los hilos para brindar soporte a tareas en segundo plano.
Su vida depende de los hilos de usuarios.

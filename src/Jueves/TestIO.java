...
Java utiliza el concepto de flujo (stream) para hacer que la operacion E/S sea rapida

El paquete de java.io contiene todas las clases necesarias para las operaciones de entradas y salidas

Podemos realizar el manejo de archivos a traves de Java I/O API

STREAM:
Es un flujo de datos compuestos por byte.

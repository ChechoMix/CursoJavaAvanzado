...
De esta manera podermos suspender, reanudar o interrumpir el grupo de hilos mediante
una sola llamada al metodo.

Solo hay dos constructores de la clase ThreadGroup 
1.- ThreadGroup(String name) crea un grupo de hilos con nombre.
2.- ThreadGroup(ThreadGroup parent, String name) crea un grupo de hilos con nombre de grupo y nombre

Metodo importantes de la clase ThreadGroup 
1.- int activeCount() regresa el numero de hilos activos en el grupo actul
2.- int activeGroupCount() regresa el numero de grupos activos en en este grupo
